...
%options.CIS_InitNUnstable  =   -1;         % MP 2018 Number of initial unstable eigs (negative means contCIS should compute it).
...
% TestTolerance (NOT SUPPORTED: cl_matcontL now makes a distinction between fun and var tolerance, see locator options below)
