function paper_testbruss_2d_BP4()
...
opt = contset(opt,'InitStepsize',   1e-2); % n = 200,     N=10
opt = contset(opt,'MaxStepsize',    1e-2); % n = 200,     N=10 
%%opt = contset(opt,'InitStepsize',   2e-1); % n = 200,     N=10
%%opt = contset(opt,'MaxStepsize',    2e-1); % n = 200,     N=10 
...
opt = contset(opt, 'Filename', 'paper_testbruss_2d_BP4');
