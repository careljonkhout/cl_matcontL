function fusion_Orb_LC_N_25
  ...
  % the reason to create a seperate file for N=25 was to be able to identify the
  % data generated by this script easily. However, since the output filename can
  % be set via contset, this was not really a good reason to create a separate
  % file
  N = 25;                     
