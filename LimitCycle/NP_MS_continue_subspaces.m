...
function V = NP_MS_continue_subspaces(delta_t, parameters)
  global cds contopts
  ...
  while p_eff < cds.p && iteration < contopts.NP_axSubspaceIterations
    ...
    while k ~= 0
      ...
      if basis_norm < contopts.NP_asisTolerance
        break
      end
      k = k - 1;
    end
