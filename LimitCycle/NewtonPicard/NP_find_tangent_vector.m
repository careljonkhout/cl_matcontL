function v = NP_find_tangent_vector(curvefile, x, v0)

  switch func2str(curvefile)
    case 'single_shooting'  ; v = NP_SS_find_tangent_vector(x);
    case 'multiple_shooting'; v = NP_MS_find_tangent_vector(x);
    ...
    otherwise
      error_format_string = ['internal error in' ...
        ' Continuer/NewtonPicard/NP_find_tangent_vector.m:\n' ...
