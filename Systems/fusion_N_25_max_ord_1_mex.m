function out = fusion_N_25_max_ord_1_mex
out{1} = @init;
out{2} = @fusion_N_25_max_ord_1_dydt;
out{3} = @fusion_N_25_max_ord_1_jacobian;
out{4} = @fusion_N_25_max_ord_1_jacobian_params;
out{5} = [];
out{6} = [];
out{7} = [];
out{8} = [];
...
handles = feval(fusion_N_25_max_ord_1);
options = odeset(...
