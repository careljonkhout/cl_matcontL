...
void reactor_N_50_cvode_max_ord_1_jacobian(double* y, double* parameters, double* dydt);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  reactor_N_50_cvode_max_ord_1_jacobian(y,parameters,outMatrix);
    
}

#define JAC(i,j) jac[(i) + (j) * system_size]

void reactor_N_50_cvode_max_ord_1_jacobian(double* y, double* parameters, double* jac) {
