...
dydt=[par_b*y(1) - 2*y(2)*pi - par_sigma*y(1)*(y(1)^2 + y(2)^2); 2*y(1)*pi + par_b*y(2) - par_sigma*y(2)*(y(1)^2 + y(2)^2)];
% --------------------------------------------------------------------------
function options = init()
handles = feval(hopf_normal_MP1);
options = odeset(...
