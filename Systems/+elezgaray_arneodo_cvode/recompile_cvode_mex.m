...
mex( ... 
  ...
  'Systems/+elezgaray_arneodo_cvode/dydt_ode.c', ... 
  'Systems/+elezgaray_arneodo_cvode/dydt_cvode.c', ... 
  'Systems/+elezgaray_arneodo_cvode/jacobian_cvode.c', ... 
  'Systems/+elezgaray_arneodo_cvode/d_sensitivity_dt.c', ... 
  '-ISystemFileGenerator/cvodes/include', ... 
  '-ISystemFileGenerator/../Systems/+elezgaray_arneodo_cvode', ... 
  ... '-g', ... % -g enables debug symbols
  '-O', ... % -O enables optimization 
  ...
  '-output', ... 
  'Systems/+elezgaray_arneodo_cvode/cvode' ... 
)

mex( ...
  'Systems/+elezgaray_arneodo_cvode/jacobian_mex.c', ...
  '-output', ... 
  'Systems/+elezgaray_arneodo_cvode/jacobian_mex' ... 
)

mex( ...
  'Systems/+elezgaray_arneodo_cvode/dydt_mex.c', ...
  'Systems/+elezgaray_arneodo_cvode/dydt_ode.c', ...
  '-output', ... 
  'Systems/+elezgaray_arneodo_cvode/dydt_mex' ...
)
