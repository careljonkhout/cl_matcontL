...
%   unknown functions and 1 unknown parameter.
  ...
  sol = bvp4c(@ex8ode,@ex8bc,solinit);
  ...
  for i=2:3
    R = R*10; 
    % After creating function handles, the new value of R 
    % will be used in nested functions.
    sol = bvp4c(@ex8ode,@ex8bc,sol);
    fprintf('For R = %5i, A = %4.2f.\n',R,sol.parameters);
